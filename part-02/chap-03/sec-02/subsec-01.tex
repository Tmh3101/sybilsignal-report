...
\indent Trong quá trình thực nghiệm, đề tài áp dụng hai chiến lược huấn luyện khác nhau tùy thuộc vào kiến trúc mô hình. Đối với các mô hình GNN cơ sở, quy trình huấn luyện được thực hiện theo phương thức học có giám sát từ đầu đến cuối. Ngược lại, đối với kiến trúc \textit{Decoupled GNN-ML}, hệ thống sử dụng GNN như một bộ trích xuất đặc trưng để huấn luyện các bộ phân lớp máy học truyền thống.\vspace{0.3cm}
...
\begin{itemize}[label={--}, itemsep=1pt]
    ...
    \item \textbf{Phạm vi Quý:} Do quy mô đồ thị lớn, số epoch được tăng lên 5000; ngưỡng dừng sớm $patience=200$; tối ưu số cụm $K$ trong khoảng $[160, 180]$.
\end{itemize}
...
Quá trình huấn luyện áp dụng chung một bộ thiết lập siêu tham số như sau:
\begin{itemize}[label={--}, itemsep=1pt]
    ...
    \item \textbf{Hàm mất mát:} Đề tài sử dụng hàm \textit{Weighted Cross-Entropy}. Thay vì tính lỗi đồng đều cho mọi mẫu dữ liệu, hàm này tích hợp trực tiếp các giá trị \textit{Class Weights} (đã được tính toán ở Chương 2).
