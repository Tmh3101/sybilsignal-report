...
Sau khi phân tách không gian thành các cụm, hệ thống áp dụng hệ luật trọng số để chấm điểm rủi ro cho từng cụm. Dựa trên điểm số này, hàng trăm vi cụm được ánh xạ và hợp nhất về 04 loại nhãn vĩ mô chính:
\begin{itemize}[label={--}, itemsep=1pt]
